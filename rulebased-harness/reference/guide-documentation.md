...
|----|------|----------|--------|
| docs-readme | README.md | important | 2 |
| docs-gitignore | .gitignore | important | 2 |
| docs-license | LICENSE 파일 | nice-to-have | 1 |
| docs-changelog | CHANGELOG | nice-to-have | 1 |

**만점**: 6점 (important 4 + nice-to-have 2)
