...
|----|------|----------|--------|
| auto-context-completeness | 컨텍스트 완성도 | important | 2 |
| auto-tool-config | 도구 설정 (MCP/Skills) | nice-to-have | 1 |
| auto-memory-system | 메모리 시스템 | nice-to-have | 1 |

**만점**: 4점 (important 2 + nice-to-have 2)
